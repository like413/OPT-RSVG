...
def get_args_parser():
    ...
    parser.add_argument('--eval_model', default='./checkpoint/checkpoint.pth', type=str)
...
def main(args):
    ...
    print('test_set:', len(dataset_test))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('LPVA evaluation script', parents=[get_args_parser()])
